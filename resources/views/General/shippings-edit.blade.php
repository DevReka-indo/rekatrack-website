        ...
        <form method="POST" action="{{ route('shippings.update', $travelDocument->id) }}" id="editShippingForm">
            ...
            <div class="page-hero">
                <div class="hero-left">
                    ...
                    <div class="hero-sjn">{{ $travelDocument->no_travel_document ?? '-' }}</div>
                </div>
                <div style="position:relative">
                    <a href="{{ route('shippings.detail', $travelDocument->id) }}" class="btn"
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="posting-info">
                                ...
                                @endif
                                <span>Posting:
                                    {{ $travelDocument->posting_date ? \Carbon\Carbon::parse($travelDocument->posting_date)->format('d/m/Y') : '-' }}
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="sendTo" value="{{ old('sendTo', $travelDocument->send_to) }}"
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="poNumber" value="{{ old('poNumber', $travelDocument->po_number) }}"
                ...
                <div class="form-section-body">
                    <div id="attachmentContainer">
                        ...
                        @elseif(($travelDocument->attachments ?? collect())->count())
                            @foreach ($travelDocument->attachments ?? collect() as $att)
                                <div class="attachment-row mb-2">
                                    <div class="input-group">
                                        <span class="input-group-text bg-transparent text-muted"
                                            style="font-size:.8rem;border-right:none;"><i
                                                class="fas fa-file-text"></i></span>
                                        <input type="text" name="attachments[]" value="{{ $att->name }}"
                                        ...
                                        <div class="row g-2">
                                            ...
                                            <div class="col-4">
                                                ...
                                                <input type="number" name="no[]"
                                                    value="{{ old("no.$index", $item['no'] ?? ($item['itemNo'] ?? '')) }}"
                                        ...
                                        <div class="subitems-wrapper">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <input type="text" name="subItemGroupTitle[]"
                                                    ...
                                                    class="form-control @error("subItemGroupTitle.$index") is-invalid @enderror"
                                                    placeholder="Contoh: PIDS A" />
                                                @error("subItemGroupTitle.$index")
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            ...
                                            <div class="subitems-container">
                                                ...
                                                @if (is_array(old("subItems.$index")) && count(old("subItems.$index")))
                                                    @foreach (old("subItems.$index") as $sIndex => $sub)
                                                    ...
                                                    @endforeach
                                                @elseif(isset($item['subItems']) && is_array($item['subItems']) && count($item['subItems']))
