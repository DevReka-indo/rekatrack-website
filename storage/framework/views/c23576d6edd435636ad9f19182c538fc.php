    ...
    <table style="width: 100%; margin-bottom: 1rem;">
        <tr>
            ...
            <td style="width: 70%; vertical-align: top;">
                <img src="<?php echo e(public_path('images/logo/logo-reka.png')); ?>" alt="Logo" style="max-width: 180px; margin-bottom: 0.5rem;">
            ...
            <td style="width: 30%; text-align: right; vertical-align: top;">
                <img src="data:image/svg+xml;base64, <?php echo $qrCode; ?>" alt="QR Code" style="max-width: 80px; height: auto; margin-top: 0.5rem;">
