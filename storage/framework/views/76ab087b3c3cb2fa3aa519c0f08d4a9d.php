...
<?php
    $pageName = 'Detail Pengiriman ' . ($travelDocument->no_travel_document ?? '');
?>
...
<div class="detail-wrapper">
  ...
  <div class="page-hero">
    <div class="hero-left">
      ...
      <h2 class="hero-title"><?php echo e($travelDocument->no_travel_document ?? 'Tanpa Nomor'); ?></h2>
      ...
      <?php else: ?>
        <span class="status-pill belum"><i class="fas fa-question-circle"></i> <?php echo e($travelDocument->status ?? '-'); ?></span>
      <?php endif; ?>
    </div>
    <div class="hero-actions">
      <a href="<?php echo e(route('tracking.detail', $travelDocument->id)); ?>" class="btn btn-tracking">
        ...
        <div class="detail-card-body">
            ...
            <div class="info-tile full">
              ...
              <div class="w-100">
                ...
                <div class="d-flex flex-wrap gap-2 align-items-center">
                  <div class="info-tile-value"><?php echo e($travelDocument->driver_name ?: '-'); ?></div>
                  ...
                  <div class="d-flex align-items-center gap-2">
                    ...
                    <div class="info-tile-value"><?php echo e($travelDocument->vehicle_number ?: '-'); ?></div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <?php if($travelDocument->start_time && $travelDocument->end_time): ?>
            <div class="duration-banner">
              ...
              Durasi Pengiriman:
              <strong><?php echo e(\Carbon\Carbon::parse($travelDocument->start_time)->diffForHumans(\Carbon\Carbon::parse($travelDocument->end_time), true)); ?></strong>
            </div>
          <?php endif; ?>
        </div>
      </div>
      ...
      <div class="detail-card">
        ...
        <div class="detail-card-body">
          <div class="ref-row">
            ...
            <span class="ref-value"><?php echo e($travelDocument->no_travel_document ?? '-'); ?></span>
          </div>
          <div class="ref-row">
            <span class="ref-label">PO Number</span>
            <span class="ref-value"><?php echo e($travelDocument->po_number ?? '-'); ?></span>
          </div>
          <div class="ref-row">
            <span class="ref-label">Referensi</span>
            <span class="ref-value"><?php echo e($travelDocument->reference_number ?? '-'); ?></span>
          </div>
          <div class="ref-row">
            <span class="ref-label">Reference Date</span>
            <span class="ref-value">
              <?php if(!empty($travelDocument->reference_date)): ?>
                <?php echo e(\Carbon\Carbon::parse($travelDocument->reference_date)->format('d M Y')); ?>
          ...
          <div class="ref-row">
            <span class="ref-label">Pengirim</span>
            <span class="ref-value">
              <?php if(isset($travelDocument->driver) && $travelDocument->driver): ?>
                <?php echo e($travelDocument->driver->name); ?>

                <span style="font-weight:400;color:var(--gray-500)">(<?php echo e($travelDocument->driver->nip); ?>)</span>
              <?php else: ?>
                -
              <?php endif; ?>
            </span>
          ...
          <div class="ref-row">
            ...
            <span class="ref-value"><?php echo e($travelDocument->delivery_type ?? ($travelDocument->delivery_tipe ?? '-')); ?></span>
          </div>
          <div class="ref-row" style="flex-direction:column;gap:.5rem;">
            <span class="ref-label">Lampiran</span>
            <?php if($travelDocument->attachments->isNotEmpty()): ?>
              <div class="d-flex flex-wrap gap-2">
                <?php $__currentLoopData = $travelDocument->attachments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attachment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <span class="attachment-chip"><i class="fas fa-paperclip"></i> <?php echo e($attachment->name); ?></span>
  ...
  <div class="items-table-wrapper">
    <div class="items-table-header">
      ...
      <div class="d-flex gap-2">
        <span class="count-chip blue"><i class="fas fa-cube"></i> <?php echo e($travelDocument->items->count()); ?> Item</span>
        <span class="count-chip cyan"><i class="fas fa-layer-group"></i> <?php echo e($subCount); ?> Sub Item</span>
      </div>
    </div>
          ...
          <?php $__empty_1 = true; $__currentLoopData = $travelDocument->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <tr class="parent-row">
              <td style="text-align:center">
                <div class="item-no" style="margin:0 auto"><?php echo e($item->no ?? ($index + 1)); ?></div>
              </td>
              <td>
              ...
              <td><span class="code-badge"><?php echo e($item->item_code); ?></span></td>
              <td style="text-align:center"><span class="qty-send"><?php echo e($item->qty_send ?? '-'); ?></span></td>
              <td style="text-align:center"><span class="qty-po"><?php echo e($item->qty_po ?? '-'); ?></span></td>
              <td style="text-align:center"><span class="qty-total"><?php echo e($item->total_send ?? '-'); ?></span></td>
              <td style="text-align:center"><span class="unit-badge"><?php echo e($item->unit->name ?? '-'); ?></span></td>
              <td style="font-size:.82rem;color:var(--gray-500)"><?php echo e($item->information ?? '-'); ?></td>
            </tr>

            <?php if(isset($item->subItems) && $item->subItems->isNotEmpty()): ?>
              <?php if(!empty($item->sub_item_group_title)): ?>
                <tr class="subgroup-row">
                  <td style="text-align:center">
                    <span class="sub-no"><?php echo e($item->no ?? ($index + 1)); ?>.*</span>
                  </td>
                  <td colspan="7">
                    <div class="subgroup-title">
                      <span class="subgroup-badge"><i class="fas fa-layer-group me-1"></i> Grup</span>
                      <span><?php echo e($item->sub_item_group_title); ?></span>
                    </div>
                  </td>
                </tr>
              <?php endif; ?>
              ...
              <?php $__currentLoopData = $item->subItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sIndex => $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php $subRowClass = $loop->last ? 'sub-row sub-group-end' : 'sub-row'; ?>
                <tr class="<?php echo e($subRowClass); ?>">
                  <td style="text-align:center">
                    <span class="sub-no"><?php echo e($item->no ?? ($index + 1)); ?>.<?php echo e($sIndex + 1); ?></span>
                  </td>
                  <td>
                    <div class="d-flex align-items-start gap-2">
                      <span class="sub-pill"><i class="fas fa-level-down-alt"></i> Sub</span>
                      <div>
                        <div style="font-weight:600;color:var(--gray-800)"><?php echo e($sub->item_name); ?></div>
                        <?php if(!empty($sub->description) && $sub->description !== '-'): ?>
                          <div class="item-desc"><?php echo e($sub->description); ?></div>
                        <?php endif; ?>
                      </div>
                    </div>
                  </td>
                  <td><span class="code-badge"><?php echo e($sub->item_code); ?></span></td>
                  <td style="text-align:center"><span class="qty-send"><?php echo e($sub->qty_send ?? '-'); ?></span></td>
                  <td style="text-align:center"><span class="qty-po"><?php echo e($sub->qty_po ?? '-'); ?></span></td>
                  <td style="text-align:center"><span class="qty-total"><?php echo e($sub->total_send ?? '-'); ?></span></td>
                  <td style="text-align:center"><span class="unit-badge"><?php echo e($sub->unit->name ?? '-'); ?></span></td>
                  <td style="font-size:.82rem;color:var(--gray-500)"><?php echo e($sub->information ?? '-'); ?></td>
                </tr>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <?php endif; ?>
  ...
  <div class="bottom-bar">
    <div>
      <a href="<?php echo e(route('shippings.index')); ?>" class="btn btn-back">
        <i class="fas fa-arrow-left me-1"></i> Kembali
      </a>
    </div>
    <div class="d-flex gap-2 flex-wrap">
      <?php if($travelDocument->status === 'Terkirim'): ?>
        <a href="<?php echo e(route('shippings.report', $travelDocument->id)); ?>" class="btn btn-report">
          <i class="fas fa-file-invoice me-1"></i> Bukti Pengiriman
        </a>
      <?php endif; ?>
      <a href="<?php echo e(route('shippings.edit', $travelDocument->id)); ?>" class="btn btn-edit">
