...
<head>
  <meta charset="utf-8">
  <title>Bukti Pengiriman - <?php echo e($travelDocument->no_travel_document ?? ''); ?></title>
  ...
  <div class="header">
    ...
    <div class="header-brand">
      <?php if(file_exists($logoPath)): ?>
        <img class="logo-img" src="<?php echo e($logoPath); ?>" alt="Logo Reka">
      <?php endif; ?>
    ...
    <div class="header-meta">
      <div class="meta-badge">
        ...
        <div class="meta-value"><?php echo e($travelDocument->no_travel_document ?? '-'); ?></div>
        <div class="meta-value-sm">
          Dicetak: <?php echo e($printedAt ? $printedAt->format('d M Y, H:i') : '-'); ?> WIB
        </div>
      </div>
    </div>
    ...
    <div class="status-strip">
      ...
      <div class="status-text">
        ...
        <div class="status-desc">
          Diterima oleh <b><?php echo e($confirmation->receiver_name ?? '-'); ?></b>
          pada <?php echo e(\Carbon\Carbon::parse($confirmation->received_at)->format('d F Y, H:i')); ?> WIB
        </div>
      </div>
    </div>
    <?php endif; ?>
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="info-row">
              ...
              <div class="val"><?php echo e($travelDocument->no_travel_document ?? '-'); ?></div>
            </div>
            ...
            <div class="info-row">
              ...
              <div class="val">
                <?php if($travelDocument->driver): ?>
                  ...
                  <span class="val-sub">NIP: <?php echo e($travelDocument->driver->nip ?? '-'); ?></span>
                <?php else: ?>
                  -
                <?php endif; ?>
              </div>
            ...
            <div class="info-row">
              ...
              <div class="val">
                <?php if($travelDocument->document_date): ?>
                  <?php echo e(\Carbon\Carbon::parse($travelDocument->document_date)->format('d F Y')); ?>
            ...
            <div class="info-row">
              ...
              <div class="val"><?php echo e($travelDocument->send_to ?? '-'); ?></div>
            </div>

            <div class="info-row">
              <div class="lbl">Proyek</div>
              <div class="val"><?php echo e($travelDocument->project ?? '-'); ?></div>
            </div>
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="info-row">
              ...
              <div class="val"><?php echo e($confirmation->receiver_name ?? '-'); ?></div>
            </div>
            ...
            <div class="info-row">
              ...
              <div class="val">
                <?php if(!empty($confirmation?->received_at)): ?>
                  <?php echo e(\Carbon\Carbon::parse($confirmation->received_at)->format('d F Y')); ?>

                  <span class="val-sub"><?php echo e(\Carbon\Carbon::parse($confirmation->received_at)->format('H:i')); ?> WIB</span>
                <?php else: ?>
                  -
                <?php endif; ?>
              </div>
            ...
            <div class="info-row">
              ...
              <div class="val">
                <?php if($travelDocument->start_time): ?>
                  <?php echo e(\Carbon\Carbon::parse($travelDocument->start_time)->format('d F Y')); ?>

                  <span class="val-sub"><?php echo e(\Carbon\Carbon::parse($travelDocument->start_time)->format('H:i')); ?> WIB</span>
                <?php else: ?>
                  -
                <?php endif; ?>
              </div>
        ...
        <div class="card">
          <div class="card-head">
            ...
            <div class="card-head-right">
              <span class="card-badge"><?php echo e(is_array($photos) ? count($photos) : 0); ?> foto</span>
            </div>
          </div>
          <div class="card-body">
            <?php if(is_array($photos) && count($photos)): ?>
              <div class="photos-wrap">
                <?php $__currentLoopData = $photos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <?php $src = $resolvePhoto($p); ?>
                  <?php if($src): ?>
                    <div class="photo-cell">
                      <div class="photo-frame">
                        <img src="<?php echo e($src); ?>" alt="Foto bukti pengiriman">
                      </div>
                    </div>
                  <?php endif; ?>
          ...
          <div class="card-body">
            <div class="note-box">
              <?php if(!empty($confirmation->note)): ?>
                <?php echo nl2br(e($confirmation->note)); ?>
  ...
  <div class="footer">
    <div class="footer-left">
      <div class="footer-doc-no">
        Dokumen: <b><?php echo e($travelDocument->no_travel_document ?? '-'); ?></b>
        &nbsp;&bull;&nbsp; Dicetak <?php echo e($printedAt ? $printedAt->format('d M Y, H:i') : '-'); ?> WIB
      </div>
    </div>
...
<?php /**PATH /home/server/Reka/current-rekatrack/current/resources/views/General/shippings-print-report.blade.php ENDPATH**/ ?>